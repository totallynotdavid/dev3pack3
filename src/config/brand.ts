...
export const brandConfig = {
  ...
  tagline:
    "Trade government contracts at the best rates. Secure, transparent, instant settlements.",

  /** Homepage meta description */
  description:
    "Buy and sell government contracts with pending payments. Competitive pricing through real-time negotiation.",
 ...
 * @param year - Optional year override. If not provided, uses 2026.
 */
export function getCopyrightText(year?: number): string {
  const currentYear = year ?? 2026;
  return `© ${currentYear} ${brandConfig.copyrightHolder}. All rights reserved.`;
}
