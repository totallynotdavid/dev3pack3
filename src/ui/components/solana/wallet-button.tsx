        ...
        <div className="absolute right-0 top-full z-50 mt-2 w-72 rounded-xl border border-border-low bg-card p-4 shadow-lg">
          ...
          {cluster !== "mainnet" && (
            <button
              ...
              className="mt-2 w-full cursor-pointer rounded-lg border border-blue-500/20 bg-blue-500/5 px-3 py-2 text-xs font-medium text-blue-600 transition hover:bg-blue-500/10 disabled:opacity-50"
            >
